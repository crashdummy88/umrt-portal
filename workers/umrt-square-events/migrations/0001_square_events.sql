-- umrt-square-events Worker D1 schema.
-- Claude-readable structured log. Portal consumes later (does not own this DB).
-- Additive. No Square catalog IDs invented here.
